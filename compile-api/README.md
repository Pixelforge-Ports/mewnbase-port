...
Only org/portmaster/mewnbase classes are written to mewnbase-host.jar. All
com/orangepixel declarations and open-source dependencies are excluded. The player
supplies the unchanged supported mewnbase.jar for the real runtime implementation.
