"""Build the MewnBase PortMaster host and BYO-data ZIP without proprietary game data."""
import argparse
import hashlib
import os
...
SHA256 = '9452d5588c457995599a3fb95ef6d570fa4aa2f3d367bd0dbe2d63a303272b6c'
...
def main():
    ...
    if args.package_only:
        if not (ROOT/'package/mewnbase/runtime/mewnbase-host.jar').is_file():
    ...
    runtime = ROOT/'package/mewnbase/runtime'
    runtime.mkdir(parents=True, exist_ok=True)
    with zipfile.ZipFile(runtime/'mewnbase-host.jar', 'w') as out:
        # Only adaptation classes ship. Compile declarations and libraries never do.
        for path in sorted((classes/'org/portmaster/mewnbase').rglob('*.class')):
